 ...
 * 
 * @version
 * 4.0.1 (Sun, 13 Aug 2017 10:43:49 GMT)
 * 
 * @copyright
	...
	Renderer.prototype = {
	  ...
	  wrapLinesWithCode: function wrapLinesWithCode(str, css) {
	    ...
	    for (i = 0, l = lines.length; i < l; i++) {
	      ...
	      if (line.length > 0) {
	        ...
	        line = line.length === 0 ? spaces : spaces + '<span class="' + css + '">' + line + '</span>';
	      }
	  ...
	  getCodeLinesHtml: function getCodeLinesHtml(html, lineNumbers) {
	    ...
	    for (var i = 0, l = lines.length; i < l; i++) {
	      ...
	      html += _this.wrapLine(i, lineNumber, (spaces != null ? '<span class="' + brushName + ' spaces">' + spaces + '</span>' : '') + line);
	    }
...
//	    html = '<pre class="' + classes.join(' ') + '"><span class="langIcon"></span><table border="0" cellpadding="0" cellspacing="0">' + _this.getTitleHtml(opts.title) + '<tbody><tr>' + (gutter ? '<td class="gutter">' + _this.renderLineNumbers(code) + '</td>' : '') + '<td class="code"><div class="container">' + html + '</div></td></tr></tbody></table></pre>';
	
	    html = '<pre class="' + classes.join(' ') + '"><div class="table">' + (gutter ? '<div class="gutter">' + _this.renderLineNumbers(code) + '</div>' : '') + '<code class="code"><div class="container">' + html + '</div></code></div></pre>';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Brush() {
	  ...
	  var values = 'print screen stringspace';

	  var fonts = '[mM]onospace [tT]ahoma [vV]erdana [aA]rial [hH]elvetica [sS]ans-serif [sS]erif [cC]ourier mono sans serif sourcecode icomoon pavanam titillium';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Brush() {
	  ...
	  var functions = 'addEventListener blur focus getAttribute getElementById match removeEventListener replace setAttribute';
	  ...
	  this.regexList = [{
		...
		regex: new RegExp(this.getKeywords(functions), 'gmi'),
		css: 'functions'
	  }, {
